...
function Combat_Routine(int xAction)
{
	...
	if ${SpellCnt}<${SpellMax} && ${Me.Ability[${SpellType[360]}].IsReady}
	{
	...
	if ${UseBallLightning} && ${SpellCnt}<${SpellMax} && ${Me.Ability[${SpellType[97]}].IsReady}
	{
	...
	if ${UseStormBolt} && ${SpellCnt}<${SpellMax} && ${Me.Ability[${SpellType[96]}].IsReady}
	{
		call CheckCondition Power 40 100
		if ${Return.Equal[OK]}
		{	
	...
	;starnova
	if ${SpellCnt}<${SpellMax} && ${Me.Ability[${SpellType[90]}].IsReady}
	{
	...
	;Wrath of nature
	if ${SpellCnt}<${SpellMax} && ${Me.Ability[${SpellType[379]}].IsReady}
	{
		call CheckCondition Power 20 100
		if ${Return.Equal[OK]}
		{	
	...
	;thunderbolt
	if ${SpellCnt}<${SpellMax} && ${Me.Ability[${SpellType[60]}].IsReady}
	{
		call CheckCondition Power 20 100
		if ${Return.Equal[OK]}
		{	
	...
	;;;; Master Strike
	if ${SpellCnt}<${SpellMax} && ${Me.Ability[Master's Smite].IsReady} && ${Mob.CheckActor[${KillTarget}]}
	{
	...
	;tempest
	if ${SpellCnt}<${SpellMax} && ${Me.Ability[${SpellType[70]}].IsReady}
	{
		call CheckCondition Power 20 100
		if ${Return.Equal[OK]}
		{	
	...
	;deathswarm
	if ${SpellCnt}<${SpellMax} && ${Me.Ability[${SpellType[51]}].IsReady}
	{
		call CheckCondition Power 20 100
		if ${Return.Equal[OK]}
		{	
	...
	;thunderspike
	if ${SpellCnt}<${SpellMax} && ${Me.Ability[${SpellType[383]}].IsReady}
	{
		call CheckCondition Power 20 100
		if ${Return.Equal[OK]}
		{	
	...
	;melee spike
	if ${SpellCnt}<${SpellMax} && ${Actor[${KillTarget}].Distance}<6 && ${Me.Ability[${SpellType[383]}].IsReady}
	{
		call CheckCondition Power 20 100
		if ${Return.Equal[OK]}
		{	
