;============================================
;
;EQ2BotLib version 20080423a
;by karye
;updated by pygar
;
; 20080423a (Pygar)
; * Made Persistent Following an Option.  Click it to resume follow every 5 seconds.  Leave it blank to only resume follow post combat or zone
; 20080406a (Amadeus)
