...
; Moving Navigation variable declaration into main func
;variable Navigation EQ2Nav
variable bool EnableNavigation=TRUE
...
function main(... Args)
{
	...
	while ${ArgCount} <= ${Args.Used}
	{
		...
		{
		case -NoNav
			EnableNavigation:Set[FALSE]
		}
		ArgCount:Inc
	}
	if ${EnableNavigation}
		declarevariable EQ2Nav script Navigation
