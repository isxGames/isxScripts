...
function IsCasting()
{
	while ${VG.InGlobalRecovery}>0 || ${Me.IsCasting} || ${Pawn[me].IsMounted}
	{
		...
		if ${VG.InGlobalRecovery}>0 && (${Status.Equal[Mounted - No Script Casting]} || ${Status.Equal[Waiting]}
