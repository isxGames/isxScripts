...
atom(global) BuildArcane()
{
	...
	UIElement[ArcaneList@MobsCFrm@Mobs@VGT@vgtwodot]:ClearItems
	while ( ${Iterator.Key(exists)} )
	{
		UIElement[ArcaneList@MobsCFrm@Mobs@VGT@vgtwodot]:AddItem[${Iterator.Key}]
		Iterator:Next
	}
}
...
atom(global) BuildPhysical()
{
	...
	UIElement[PhysicalList@MobsCFrm@Mobs@VGT@vgtwodot]:ClearItems
	while ( ${Iterator.Key(exists)} )
	{
		UIElement[PhysicalList@MobsCFrm@Mobs@VGT@vgtwodot]:AddItem[${Iterator.Key}]
		Iterator:Next
	}
}
...
atom(global) BuildFire()
{
	...
	UIElement[FireList@MobsCFrm@Mobs@VGT@vgtwodot]:ClearItems
	while ( ${Iterator.Key(exists)} )
	{
		UIElement[FireList@MobsCFrm@Mobs@VGT@vgtwodot]:AddItem[${Iterator.Key}]
		Iterator:Next
	}
}
...
atom(global) BuildColdIce()
{
	...
	UIElement[ColdIceList@MobsCFrm@Mobs@VGT@vgtwodot]:ClearItems
	while ( ${Iterator.Key(exists)} )
	{
		UIElement[ColdIceList@MobsCFrm@Mobs@VGT@vgtwodot]:AddItem[${Iterator.Key}]
		Iterator:Next
	}
}
