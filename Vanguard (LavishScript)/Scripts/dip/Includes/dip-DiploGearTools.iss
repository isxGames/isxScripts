...
objectdef obj_diplogear
{
	...
	method LS()
	{
		...
		;; We want to import previous settings from mmoAddict's vg_objects
		variable filepath ConfigPath = "${Script.CurrentDirectory}/Save/"
		if !${ConfigPath.FileExists[DiploGear_${Me.FName}.xml]}
		{
			LavishSettings[DiploGear]:Import[${LavishScript.CurrentDirectory}/scripts/vg_objects/save/Obj_DiploGear_${Me.FName}.xml]
		}
		else
		{
			LavishSettings[DiploGear]:Import[${Script.CurrentDirectory}/Save/DiploGear_${Me.FName}.xml]
		}
	...
	method XMLSave(int di, bool debug)
	{
		...
		LavishSettings[DiploGear]:Export[${Script.CurrentDirectory}/Save/DiploGear_${Me.FName}.xml]
	}
	;============================
	/*  Save Variables to XML  */
	;============================
	method XMLSave2(int di, bool debug)
	{
		;Load Lavish Settings
...
variable(global) obj_diplogear DiploGear
