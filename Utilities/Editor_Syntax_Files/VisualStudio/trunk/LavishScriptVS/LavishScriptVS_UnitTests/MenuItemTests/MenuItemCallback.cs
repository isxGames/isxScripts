...
using Company.LavishScriptVS;

namespace LavishScriptVS_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new LavishScriptVSPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Company.LavishScriptVS.GuidList.guidLavishScriptVSCmdSet, (int)Company.LavishScriptVS.PkgCmdIDList.cmdidInsertSnippet);
