...
;===================================================
	...
	method FindLowestHealth()
	{
		...
		;if (${Math.Calc[${Math.Calc[${Script.RunningTime}-${This.NextCalled}]}/1000]} < .1)
		;{
		;	return
		;}
		...
		;; Update our variables with final result
		if ${GroupNumber}
		{
			This.GroupNumber:Set[${GroupNumber}]
			This.GroupName:Set[${Group[${GroupNumber}].Name}]
			This.GroupHealth:Set[${Group[${GroupNumber}].Health}]
			This.TotalGroupWounded:Set[${GroupWounded}]
		}
		else
		{
			This:Reset
		...
		if ${GroupNumber}
		{
			This.RaidNumber:Set[${GroupNumber}]
			This.RaidName:Set[${Group[${GroupNumber}].Name}]
			This.RaidHealth:Set[${Group[${GroupNumber}].Health}]
			This.TotalRaidWounded:Set[${GroupWounded}]
		}
		else
		{
			This:Reset
	...
	{
		vgecho Find Group Members called
		This.GroupMemberCount:Set[0]
		This.CounterDelay:Set[0]
	}
